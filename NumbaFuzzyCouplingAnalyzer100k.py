...
def main():
    ...
    filenames = ['N01_imputed_SNP_filtered_skip100000.vcf.gz','N03_imputed_SNP_filtered_skip100000.vcf.gz','N04_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N05_imputed_SNP_filtered_skip100000.vcf.gz','N06_imputed_SNP_filtered_skip100000.vcf.gz','N07_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N08_imputed_SNP_filtered_skip100000.vcf.gz','N09_imputed_SNP_filtered_skip100000.vcf.gz','N10_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N11_imputed_SNP_filtered_skip100000.vcf.gz','N12_imputed_SNP_filtered_skip100000.vcf.gz','N13_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N14_imputed_SNP_filtered_skip100000.vcf.gz','N16_imputed_SNP_filtered_skip100000.vcf.gz','N17_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N18_imputed_SNP_filtered_skip100000.vcf.gz','N19_imputed_SNP_filtered_skip100000.vcf.gz','N20_imputed_SNP_filtered_skip100000.vcf.gz',
                 'N21_imputed_SNP_filtered_skip100000.vcf.gz','N22_imputed_SNP_filtered_skip100000.vcf.gz',]
    ...
    for key in samples:
        ...
        results_df[key].to_csv('{}_NumbaFuzzyCouplingAnalyzer100k.tsv.gz'.format(key), sep='\t', header=False, index=False)
